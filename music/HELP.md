...
* The following dependencies are not known to work with Spring Native: 'Rest Repositories, Spring Boot DevTools'. As a result, your application may not work as expected.
